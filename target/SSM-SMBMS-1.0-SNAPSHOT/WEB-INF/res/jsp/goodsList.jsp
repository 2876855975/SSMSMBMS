                            ...
                            <div class="text-muted font-13 m-b-30">
                                <form action="/goods/list" method="post" class="row">
                                    <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="">
                                            <input id="did" name="gid" type="text" value="<c:if test="${pager.params.gid>0}">${pager.params.gid}</c:if>" class="form-control" placeholder="商品编号">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                        <label class="">商品名称：</label>
                                        <div class="">
                                            <input id="dname" name="gname" value="${pager.params.gname}" type="text" class="form-control" placeholder="商品名称">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3 col-sm-3 col-xs-12">
