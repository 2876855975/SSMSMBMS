        ...
        <div class="right_col" role="main">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>修改供应商信息<small>请填写：</small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <form action="/supplier/doModifySupplier" id="userForm" name="userForm" class="form-horizontal form-label-left"  method="post" >
                                <!-- 错误信息-->
                                <!--<span class="section"><code >出错拉！</code></span>-->
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="userCode">供应商编号：</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <input value="${supplier.did}" readonly class="form-control" type="text" name="did" id="userCode">
                                        <!-- 放置提示信息 -->
                                        <span color="red"></span>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 ">
                                        <input maxlength="30" readonly value="${supplier.dname}" class="form-control" type="text" name="dname" id="userName" >
                                        <span color="red"></span>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input readonly value="${supplier.dtel}" class="form-control" type="text" name="dtel" id="phone">
                                        <span color="red"></span>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="phone">供应商邮箱：</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input readonly value="${supplier.demail}" class="form-control" type="text" name="demail" id="email">
                                        <span color="red"></span>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="address">供应商地址：</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
